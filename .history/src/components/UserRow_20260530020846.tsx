 ...
 *
 * Icons are loaded from the /public folder as static SVG files:
 *   /public/edit.svg   → pencil icon on the Edit button
 *   /public/delete.svg → trash icon on the Delete button
 *
 * Why /public?
 *   Files placed in /public are served by Vite as-is at the root URL.
 *   So /public/edit.svg is accessible as /edit.svg in the browser.
 *   This keeps SVG files separate from component code and easy to replace.
 */
...
export function UserRow({
  ...
  return (
    <tr className={isSelected ? 'row selected' : 'row'}>
      ...
      */}
      <td>
        <span className={`badge ${user?.role === Role.Admin ? 'badge-admin' : 'badge-member'}`}>
          {user?.role}
        </span>
      </td>
      ...
      */}
      <td>
        ...
        >
          <img src="/edit.svg" width={16} height={16} alt="" aria-hidden="true" />
        </button>
        ...
        >
          <img src="/delete.svg" width={16} height={16} alt="" aria-hidden="true" />
        </button>
      </td>
    </tr>
  );
